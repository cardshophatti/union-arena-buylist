const API_URL =
"https://opensheet.elk.sh/1Nvy2_wMoDHluMlBXdRmoVwUTM8tfxUkEIiaFe-Zuwx4/%E3%82%B7%E3%83%BC%E3%83%881";

const CACHE_KEY = "unionArenaDeckCache";
const CACHE_TIME_KEY = "unionArenaDeckCacheTime";
...
<img
  src="${card["画像URL"]}"
  class="card-item-image image-popup-trigger"
  data-image="${card["画像URL"]}"
  loading="lazy"
>
...
function filterCards() {
  ...
  card["デッキ名"]?.toLowerCase().includes(keyword);
